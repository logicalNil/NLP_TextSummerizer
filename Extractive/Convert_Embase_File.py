...
import os
try:
    BASE_PATH=r"C:\Users\nilay\Downloads\Extractive-Text-Summerization-master\Extractive-Text-Summerization-master\5. Subcutaneous Port Needle Or Huber Needle And (Bard or BD).xlsx"
